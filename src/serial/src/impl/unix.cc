...
log4cplus::Logger _logger = log4cplus::Logger::getInstance("test2"); ;
    ...
    bytesize_ (bytesize), stopbits_ (stopbits), flowcontrol_ (flowcontrol)
{
  ...
  //   time_t curtime;
  //   time (&curtime);
  //   string filepath = string("/home/tzb/new_steer/src/steer_track/log/unix/")+ctime(&curtime)+string(".log");
  //   log4cplus::SharedAppenderPtr _append(new log4cplus::FileAppender(filepath));
  //   _append->setName("filelogtest2");   
  ...
  //   /*logactivity*/
  //   // LOG4CPLUS_INFO(_logger, LOG4CPLUS_TEXT("Hello world"));
...
Serial::SerialImpl::read (uint8_t *buf, size_t size)
{
  ...
  // LOG4CPLUS_INFO(_logger, "first bytes_read:"<<bytes_read);
  while (bytes_read < size) {
    ...
    // LOG4CPLUS_INFO(_logger, "constant remaining_ms:"<<timeout_remaining_ms);
    ...
    // LOG4CPLUS_INFO(_logger, "min remaining_ms:"<<timeout);
    if (waitReadable(timeout)) {
      ...
      // LOG4CPLUS_INFO(_logger, "bytes_read_now:"<<bytes_read_now);
      ...
      // LOG4CPLUS_INFO(_logger, "after added bytes_read:"<<bytes_read);
